!(function () {
  var e = {
          ...
          (n.sendObjectBeacon = function (e, n, t, r, i) {
            ...
            if (navigator && "string" == typeof navigator.userAgent)
              try {
                ...
                c &&
                  c[0].toLowerCase().indexOf("chrome") > -1 &&
                  parseInt(c[1]) < 81 &&
                  (a = !1);
              } catch (e) {}
            if (
              ...
              null == s || s(o, new Blob([u], { type: "application/json" }));
            } else {
          ...
          var n,
            ...
            c = function (e) {
              ...
              if (n) {
                ...
                if (
                  0 === n.domContentLoadedEventStart ||
                  e < n.domContentLoadedEventStart
                )
            ...
            S = function (e) {
              "hidden" === document.visibilityState &&
                w > -1 &&
                ((w = "visibilitychange" === e.type ? e.timeStamp : 0), L());
            },
            E = function () {
                      ...
                      e.forEach(function (e) {
                        "first-contentful-paint" === e.name &&
                          ...
                          e.startTime < r.firstHiddenTime &&
                            ((i.value = Math.max(e.startTime - v(), 0)),
                            i.entries.push(e),
                            t(!0)));
                      });
                    });
                  o &&
                    ((t = g(e, i, I, n.reportAllChanges)),
                    d(function (r) {
                      ((i = p("FCP")),
                        (t = g(e, i, I, n.reportAllChanges)),
                        y(function () {
            ...
            ee = function (e, n) {
              ...
              Z(function () {
                ...
                if (i) {
                  ...
                  ((t.value = Math.max(o - v(), 0)),
                    (t.entries = [i]),
                    r(!0),
                    d(function () {
                      ((t = p("TTFB", 0)),
                        (r = g(e, t, Y, n.reportAllChanges))(!0));
                    }));
                }
              });
            };
                      ...
                      var t,
                        ...
                        a = function (e) {
                          (e.forEach(function (e) {
                            ...
                            i > r.value &&
                              ((r.value = i), (r.entries = o), t()));
                        },
                        c = m("layout-shift", a);
                      c &&
                        ((t = g(e, r, A, n.reportAllChanges)),
                        h(function () {
                          (a(c.takeRecords()), t(!0));
                        }),
                        d(function () {
                  ...
                  C(function () {
                    ...
                    var r,
                      ...
                      o = function (e) {
                        ...
                        var n,
                          t =
                            ((n = Math.min(W.length - 1, Math.floor(J() / 50))),
                            W[n]);
                        t &&
                          t.latency !== i.value &&
                    ...
                    var t,
                      ...
                      o = function (e) {
                        ...
                        n &&
                          ...
                          ((i.value = Math.max(n.startTime - v(), 0)),
                          (i.entries = [n]),
                          t());
                      },
                  ...
                  if (e.entries.length) {
                    ...
                    if (n) {
                      var t = n.activationStart || 0,
                        ...
                        c = Math.max(
                          o,
                          i ? (i.requestStart || i.startTime) - t : 0,
                        ),
      ...
      559: function (e, n) {
        "use strict";
        (Object.defineProperty(n, "__esModule", { value: !0 }),
          (n.timingsV2TargetKeys = n.timingsTargetKeys = void 0),
          (n.buildTimingsObject = function (e, n, t) {
            for (var r = 0, i = t; r < i.length; r++) {
              var o = i[r],
                a = e[o];
              void 0 !== n &&
                (("number" != typeof a && "string" != typeof a) || (n[o] = a));
            }
          }),
          (n.timingsTargetKeys = [
            "navigationStart",
        ...
        !(function () {
          ...
          !(function () {
            var n,
              ...
              l =
                ...
                ("function" == typeof document.querySelector
                  ? document.querySelector("script[".concat(f, "]"))
                  : void 0),
              d = (0, c.v4)(),
              v = [],
              ...
              if (s && p && p.token) {
                ...
                document.addEventListener("visibilitychange", function () {
                  if ("hidden" === document.visibilityState) {
                    if (L && A()) {
                      var n = e();
                      (((null == w ? void 0 : w.url) == n &&
                        (null == w ? void 0 : w.triggered)) ||
                        C(),
                        R(n));
                    }
                    !S && w && ((S = !0), I());
                ...
                var L = p && (void 0 === p.spa || !0 === p.spa),
                  ...
                  C = function (t) {
                    var r = (function (t) {
                        ...
                        if ("function" == typeof s.getEntriesByType) {
                          ...
                          if (m && Array.isArray(m) && m.length > 0) {
                            ((l.timingsV2 = {}),
                              ...
                              delete l.timings);
                            var g = m[0];
                            (0, u.buildTimingsObject)(
                              g,
                              l.timingsV2,
                              u.timingsV2TargetKeys,
                            );
                          }
                        }
                      ...
                      return (
                        (l.firstPaint = k("first-paint")),
                        (l.firstContentfulPaint = k("first-contentful-paint")),
                        p &&
                          (p.icTag && (l.icTag = p.icTag),
                          (l.siteToken = p.token)),
                        void 0 !== n && (delete l.timings, delete l.memory),
                        l
                      );
                    })(t);
                    r &&
                      ...
                      ((r.resources = []),
                      p &&
                        ((0, o.sendObjectBeacon)("", r, function () {}, !1, P),
                        void 0 !== p.forward &&
                          void 0 !== p.forward.url &&
                          (0, o.sendObjectBeacon)(
                            "",
                            r,
                            function () {},
                            !1,
                  ...
                  I = function () {
                    var n = (function () {
                      ...
                      try {
                        r =
                          "function" == typeof s.getEntriesByType
                            ? new URL(null == n ? void 0 : n.name).pathname
                            : t
                              ? new URL(t).pathname
                      ...
                      return (
                        p &&
                          (p.version && (o.versions.fl = p.version),
                          p.icTag && (o.icTag = p.icTag),
                          (o.siteToken = p.token)),
                        E &&
                          ["lcp", "fid", "cls", "fcp", "ttfb", "inp"].forEach(
                            function (e) {
                              ((o[e] = { value: -1, path: void 0 }),
                  ...
                  U = function () {
                    var n =
                      (window.__cfRl && window.__cfRl.done) ||
                      (window.__cfQR && window.__cfQR.done);
                    (n ? n.then(C) : C(),
                      (w = {
                        id: d,
                        url: e(),
                ...
                var A = function () {
                  ...
                  R = function (e) {
                    (v.push({ id: d, url: e, ts: new Date().getTime() }),
                      v.length > 3 && v.shift());
                  };
                L &&
                  ((t = e()),
            ...
            function O(e) {
              ...
              switch (
                (b || (b = e.navigationType),
                "INP" !== e.name &&
                  (E[e.name.toLowerCase()] = { value: e.value, path: u }),
                e.name)
              ) {
                case "CLS":
                  (c = e.attribution) &&
                    E.cls &&
                    ((E.cls.element = c.largestShiftTarget),
                    (E.cls.currentRect =
                      null === (n = c.largestShiftSource) || void 0 === n
                        ? void 0
                        : n.currentRect),
                    (E.cls.previousRect =
                      null === (t = c.largestShiftSource) || void 0 === t
                        ? void 0
                        : t.previousRect));
                  break;
                case "FID":
                  (c = e.attribution) &&
                    E.fid &&
                    ((E.fid.element = c.eventTarget),
                    (E.fid.name = c.eventType));
                  break;
                case "LCP":
                  (c = e.attribution) &&
                    E.lcp &&
                    ((E.lcp.element = c.element),
                    (E.lcp.size =
                      null === (r = c.lcpEntry) || void 0 === r
                        ? void 0
                        : r.size),
                    (E.lcp.url = c.url),
                    ...
                    (E.lcp.it =
                      null === (i = c.lcpResourceEntry) || void 0 === i
                        ? void 0
                        : i.initiatorType),
                    (E.lcp.fp =
                      null ===
                        (a =
                          null === (o = c.lcpEntry) || void 0 === o
                            ? void 0
                            : o.element) || void 0 === a
                        ? void 0
                  ...
                  break;
                case "INP":
                  (null == E.inp || Number(E.inp.value) < Number(e.value)) &&
                    ((E.inp = { value: Number(e.value), path: u }),
                    (c = e.attribution) &&
                      E.inp &&
                      ((E.inp.element = c.eventTarget),
            ...
            function D() {
              if (p && p.serverTiming) {
                for (
                  var e = [], n = 0, t = ["navigation", "resource"];
                  n < t.length;
                  n++
                )
                  for (
                    var r = t[n], i = 0, o = s.getEntriesByType(r);
                    i < o.length;
                    i++
                  ) {
                    var a = o[i],
              ...
              if ("function" == typeof s.getEntriesByType) {
                ...
                ((e.timingsV2 = {}),
                  n &&
                    n[0] &&
                    (n[0].nextHopProtocol &&
                      (t.nextHopProtocol = n[0].nextHopProtocol),
                    n[0].transferSize && (t.transferSize = n[0].transferSize),
                    n[0].decodedBodySize &&
                      (t.decodedBodySize = n[0].decodedBodySize),
            ...
            function k(e) {
              ...
              if ("function" == typeof s.getEntriesByType) {
                var t =
                  null === (n = s.getEntriesByType("paint")) || void 0 === n
                    ? void 0
                    : n.filter(function (n) {
                        return n.name === e;
                      })[0];
      ...
      976: function (e, n, t) {
          ...
          var r = "ffffffff-ffff-ffff-ffff-ffffffffffff",
            ...
            c = function (e) {
              ...
              return Uint8Array.of(
                (n = parseInt(e.slice(0, 8), 16)) >>> 24,
                (n >>> 16) & 255,
                (n >>> 8) & 255,
                255 & n,
                (n = parseInt(e.slice(9, 13), 16)) >>> 8,
                255 & n,
                (n = parseInt(e.slice(14, 18), 16)) >>> 8,
                255 & n,
          ...
          if (o) {
            if (a < 0 || a + 16 > o.length)
              throw new RangeError(
                "UUID byte range "
                  .concat(a, ":")
                  .concat(a + 15, " is out of buffer bounds"),
              );
        ...
        var y = function (e, n, t) {
          var r,
            ...
            a,
            c,
            u = null !== (r = null == e ? void 0 : e._v6) && void 0 !== r && r;
          if (e) {
            var s = Object.keys(e);
          ...
          if (e)
            c = g(
              null !==
                (a =
                  null !== (i = e.random) && void 0 !== i
                    ? i
                    : null === (o = e.rng) || void 0 === o
                      ? void 0
                      : o.call(e)) && void 0 !== a
                ? a
                : p(),
            ...
            (!(function (e, n, t) {
              ...
              ((null !== (r = e.msecs) && void 0 !== r) || (e.msecs = -1 / 0),
                ...
                n === e.msecs
                  ...
                  : n > e.msecs
                    ? (e.nsecs = 0)
                    : n < e.msecs && (e.node = void 0),
                e.node ||
                  ((e.node = t.slice(10, 16)),
                  (e.node[0] |= 1),
                  (e.clockseq = 16383 & ((t[8] << 8) | t[9]))),
                (e.msecs = n));
            })(m, l, d),
              (c = g(
                d,
        ...
        var C = function (e) {
            var n = (function (e) {
                ...
                for (
                  var n = new Uint32Array(T(8 * e.length)).fill(0), t = 0;
                  t < e.length;
                  t++
                )
                  n[t >> 2] |= (255 & e[t]) << ((t % 4) * 8);
              ...
              t = (function (e, n) {
                ...
                for (
                  ...
                  ((r = S(r, i, o, a, e[c], 7, -680876936)),
                    ...
                    (r = E(
                      r,
                      (i = S(i, o, a, r, e[c + 15], 22, 1236535329)),
                      o,
                      a,
                      e[c + 1],
                      5,
                    ...
                    (r = L(
                      r,
                      (i = E(i, o, a, r, e[c + 12], 20, -1926607734)),
                      o,
                      a,
                      e[c + 5],
                      4,
                    ...
                    (r = P(
                      r,
                      (i = L(i, o, a, r, e[c + 2], 23, -995338651)),
                      o,
                      a,
                      e[c],
                      6,
            ...
            return (function (e) {
              for (
                var n = new Uint8Array(4 * e.length), t = 0;
                t < 4 * e.length;
                t++
              )
                n[t] = (e[t >> 2] >>> ((t % 4) * 8)) & 255;
          ...
          var a =
              "string" == typeof t
                ? (function (e) {
                    ...
                    for (
                      var n = new Uint8Array(e.length), t = 0;
                      t < e.length;
                      ++t
                    )
                      n[t] = e.charCodeAt(t);
              ...
              ? (function (e, n, t) {
                  var r,
                    ...
                    a =
                      null !==
                        (o =
                          null !== (r = (e = e || {}).random) && void 0 !== r
                            ? r
                            : null === (i = e.rng) || void 0 === i
                              ? void 0
                              : i.call(e)) && void 0 !== o
                        ? o
                        : p();
                  if (a.length < 16)
                    throw new Error("Random bytes length must be >= 16");
                  if (
                    ((a[6] = (15 & a[6]) | 64), (a[8] = (63 & a[8]) | 128), n)
                  ) {
                    if ((t = t || 0) < 0 || t + 16 > n.length)
                      throw new RangeError(
                        "UUID byte range "
                          .concat(t, ":")
                          .concat(t + 15, " is out of buffer bounds"),
                      );
        ...
        var M = function (e) {
          ...
          for (
            ...
            for (var u = new Uint32Array(16), s = 0; s < 16; ++s)
              u[s] =
                (e[64 * c + 4 * s] << 24) |
                (e[64 * c + 4 * s + 1] << 16) |
                (e[64 * c + 4 * s + 2] << 8) |
        ...
        var F = j,
          ...
          q = function (e, n, t) {
            (null != e || (e = {}), null != t || (t = 0));
            var r = y(x(x({}, e), { _v6: !0 }), new Uint8Array(16));
            if (((r = h(r)), n)) {
          ...
          if (r) {
            if (i < 0 || i + 16 > r.length)
              throw new RangeError(
                "UUID byte range "
                  .concat(i, ":")
                  .concat(i + 15, " is out of buffer bounds"),
              );
          } else ((r = new Uint8Array(16)), (i = 0));
          return (
            null != n || (n = Date.now()),
            null != t ||
              (t = ((127 * e[6]) << 24) | (e[7] << 16) | (e[8] << 8) | e[9]),
            (r[i++] = (n / 1099511627776) & 255),
            (r[i++] = (n / 4294967296) & 255),
            (r[i++] = (n / 16777216) & 255),
            (r[i++] = (n / 65536) & 255),
            (r[i++] = (n / 256) & 255),
            (r[i++] = 255 & n),
            ...
            if (e)
              ...
              (!(function (e, n, t) {
                ...
                ((null !== (r = e.msecs) && void 0 !== r) || (e.msecs = -1 / 0),
                  ...
                  n > e.msecs
                    ? ((e.seq =
                        (t[6] << 23) | (t[7] << 16) | (t[8] << 8) | t[9]),
                      (e.msecs = n))
                    : ((e.seq = (e.seq + 1) | 0), 0 === e.seq && e.msecs++));
              })(V, c, u),
                (a = H(u, V.msecs, V.seq, n, t)));
            }
            return null != n ? n : f(a);
          },
          K = function (e) {
